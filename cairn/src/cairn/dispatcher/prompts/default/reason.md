...
- When high or critical audit findings are pending confirmation, propose confirmation intents for those finding IDs unless existing open intents already cover them.
